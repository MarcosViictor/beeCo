      ...
      <div className='flex flex-col gap-13 w-[350px] '>
        <div className='flex flex-col gap-2'>
          <h1 className='font-[400] text-[2rem] text-dark-gray leading-[2.5rem]'>
            Comece agora com o <span className='font-bold'>Bee</span>Co
          </h1>
          <p className='uppercase text-sm text-gray-500 font-light'>
            Cadastre-se grátis
          </p>
        </div>
        <div className='flex flex-col gap-4'>
          ...
          <p className='text-sm text-gray-500 text-center pt-7'>
            Já tem uma conta?{' '}
            <Link to='/login' className='text-light-yellow font-bold'>
              ENTRAR
            </Link>
          </p>
        </div>
