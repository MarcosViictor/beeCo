...
const items = [
  ...
  },
  {
    ...
    description:
      "Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing tousled waistcoat.",
    img: "https://dummyimage.com/601x361",
  },
  {
    title: "The 400 Blows",
    subtitle: "THE SUBTITLE",
    description:
      "Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing tousled waistcoat.",
    img: "https://dummyimage.com/603x363",
  },
  {
    title: "Neptune",
    subtitle: "THE SUBTITLE",
    description:
      "Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing tousled waistcoat.",
    img: "https://dummyimage.com/602x362",
  },
];
        ...
        <div>
          ...
          <div className="flex flex-col gap-5">
            ...
            <h4>
              ...
              alvenaria, acabamento, revestimentos e reformas em geral.
            </h4>
